\chapter{Grundlagen zu modernen Design-Prozessen und Erfolgsquoten}\label{sec:Grundlagen}
...
%
\input{01_Grundlagen/01_Prozesse.tex}
\input{01_Grundlagen/02_AlternativeProzesse.tex}
\input{01_Grundlagen/03_Erfolge.tex}
