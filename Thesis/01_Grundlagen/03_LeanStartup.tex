...
\begin{figure}[h!]
	\begin{center}
		...
		\caption[Modell der \ac{BML} Schleife nach dem Lean Startup Konzept]{Modell der \ac{BML} Schleife nach dem Lean Startup Konzept (Abbildung übersetzt aus \citeNP{TheLeanStartup})}
...
\begin{figure}[h!]
	\begin{center}
		...
		\caption[Unterteilung eines Projektes im Lean Startup Modell]{Unterteilung eines Projektes im Lean Startup Modell (Abbildung übersetzt aus \citeNP{TheLeanStartup})}
